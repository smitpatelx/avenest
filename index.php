...
<div class="flex flex-wrap flex-row p-4 md:p-10 lg:p-24">
    <div class="w-full md:w-1/2 flex flex-wrap flex-col">
        ...
        <h1 class="font-bold text-4xl text-primary-500 font-headline">We’ll help you find a place you’ll love.</h1>
    ...
    <div class="flex flex-wrap flex-row">
        <div class="p-2 w-full lg:w-1/3">
            <div class="rounded bg-white shadow-xl flex flex-wrap justify-center pt-2 px-2">
                ...
                <a href="./login.php" class="bg-white rounded border border-blue-600 hover:bg-primary-500 hover:text-white text-primary-500 py-2 px-3 font-semibold mb-10 mx-4 text-center">Start Buying</a>
            </div>
        </div>
        <div class="p-2 w-full lg:w-1/3">
            <div class="rounded bg-white shadow-xl flex flex-wrap  justify-center pt-2 px-2">
                ...
                <a href="./login.php" class="bg-white rounded border border-blue-600 hover:bg-primary-500 hover:text-white text-primary-500 py-2 px-3 font-semibold mb-10 mx-4 text-center">Start Selling</a>
            </div>
        </div>
        <div class="p-2 w-full lg:w-1/3">
            <div class="rounded bg-white shadow-xl flex flex-wrap  justify-center pt-2 px-2">
                ...
                <a href="./login.php" class="bg-white rounded border border-blue-600 hover:bg-primary-500 hover:text-white text-primary-500 py-2 px-3 font-semibold mb-10 mx-4 text-center">Start Renting</a>
            </div>
        </div>
    </div>
</div>
<div class="text-center pb-10 px-6">
    <h2 class="font-bold text-4xl text-primary-500 font-headline">We provide our service in multiple cities.</h2>
</div>
<div class="w-full">
