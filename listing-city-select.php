...
?>
    ...
    <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="w-full flex flex-wrap justify-center items-center py-10">
        ...
        <div class="w-2/5 flex flex-wrap justify-center">
