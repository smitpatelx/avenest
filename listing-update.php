...
<div class="w-full flex flex-wrap justify-center">
    ...
    <form class="h-auto w-full lg:w-2/3 xl:w-1/2 px-8 my-4" method="post" action="<?php echo $_SERVER['PHP_SELF'].'?listing_id='.$listing_id; ?>" enctype="multipart/form-data">
        ...
        <div class="flex flex-wrap flex-row justify-center">
            <div class="pr-3 py-2">
                <input type="submit" value="Update Listing" class="focus:outline-none focus:shadow-outline w-full py-3 px-6 shadow-lg rounded-lg hover:bg-primary bg-primary-300 text-white font-semibold cursor-pointer"/>
            </div>
            <div class="pr-3 py-2">
