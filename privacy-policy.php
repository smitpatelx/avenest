...
<div class="w-full flex flex-wrap justify-center items-center text-center px-6 md:px-10 lg:px-32 py-10 md:py-24">
    ...
    <br/><br/>
    You may connect to the Services with a third-party service and you give us permission to access, store, and use your information from that service as permitted by that service and as may be described in our Privacy Policy. If you believe your Account may have been compromised or misused, contact us immediately at Avenest Customer Support.
    <br/><br/>
    <b>Using the Services.</b> You will post in the appropriate category or area and will not do any of the following bad things:
    <br/><br/>
    </p>
    <ul class="list-disc text-left my-4 font-normal subpixel-antialiased text-lg text-gray-600">
        ...
        <li>distribute viruses or any other technologies that may harm Avenest or the interests or property of Avenest users;</li>
        <li>impose an unreasonable load on our infrastructure or interfere with the proper working of the Avenest;</li>
        <li>copy, modify, or distribute any other person's content;</li>
        <li>use any robot, spider, scraper or other automated means to access Avenest and collect content for any purpose without our express written permission;</li>
        <li>harvest or otherwise collect information about others, including email addresses, without their consent;</li>
        <li>bypass measures used to prevent or restrict access to Avenest.</li>
    </ul>
    <p class="font-normal subpixel-antialiased text-lg text-left text-gray-600">
    <br/><br/>
    Abusing Avenest Services. Please use the flagging system to tell us about any problems or offensive content so that together we can keep the Services site working properly. We may limit or terminate our Services, remove hosted content and take technical and legal steps to keep users off Avenest if we think that they are creating problems or acting inconsistently with the letter or spirit of our policies. However, whether we decide to take any of these steps, remove hosted content or keep a user off Avenest or not, we do not accept any liability for monitoring Avenest or for unauthorized or unlawful content on Avenest or use of Avenest by users.
    <br/><br/>
    Global Marketplace. Without limitation to the rights granted below (see ‘Content’), some of Avenest's features may display your ad on other sites that are part of the global eBay community, like on eBay or our classifieds sites in other countries. By using the Services, you agree that your ads can be displayed on these other sites. The terms for our other sites are similar to these terms, but you may be subject to additional laws or other restrictions in the countries where your ad is posted. When you choose to post your ad to another site, you may be responsible for ensuring that it does not violate our other site policies. We may remove your ad if it is flagged on any of our sites, or if we believe it causes problems or violates any law or policy.
    <br/><br/>
    ...
    <br/><br/>
    Indemnification. You will indemnify and hold harmless Avenest and its affiliates and our and their respective officers, directors, agents and employees (each an “Indemnified Party”), from any claim made by any third party, together with any amounts payable to the third party whether in settlement or as may otherwise be awarded, and reasonable legal costs incurred by any of the Indemnified Parties, arising from or relating to your use of the Services, any alleged violation by you of the applicable terms, and any alleged violation by you of any applicable law or regulation. We reserve the right, at our own expense, to assume the exclusive defense and control of any matter subject to indemnification by you, but doing so will not excuse your indemnity obligations.
    <br/><br/>
    Personal Information. By using Services, you agree to the collection, transfer, storage and use of your personal information by Avenest Canada Ltd. (the "data controller") on servers located in the United States and in the European Union as further described in our privacy policy.
    <br/><br/>
    Reviews.You may be asked to leave a review when messaging with other users on Avenest. Reviews consist of a 1-5-star rating and selected reasons why you’ve chosen that review. Your submitted review, user name, profile photo (if available), and the category of the seller’s listing will be made public. User reviews should be left in good faith, ensuring that both you and the other user are depicting your interaction fairly. When leaving a review on another user’s account, the review should:
