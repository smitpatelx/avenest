...
?>
    ...
    <div class="w-full flex flex-wrap justify-center">
        ...
        <form class="h-auto w-1/3 p-4" method="post">
            ...
            <div class="flex flex-wrap flex-row mt-24">
                <div class="w-1/2 pr-2 py-2">
                    <input type="text" name="first_name" placeholder="First name" class="w-full p-2 shadow rounded-lg">
                </div>
                <div class="w-1/2 pl-2 py-2">
                    <input type="text" name="last_name" placeholder="Last name" class="w-full p-2 shadow rounded-lg">
                </div>
            </div>
            <input type="text" placeholder="Email" class="w-full p-2 shadow rounded-lg my-2">
            <div class="flex flex-wrap flex-row">
                <div class="w-1/2 pr-2 py-2">
                    <input type="password" name="password" placeholder="Password" class="w-full p-2 shadow rounded-lg">
                </div>
                <div class="w-1/2 pl-2 py-2">
                    <input type="password" name="confirm_password" placeholder="Confirm Password" class="w-full p-2 shadow rounded-lg">
                </div>
            </div>
            <div class="flex flex-wrap flex-row">
                <div class="w-1/2 pr-2 py-2">
                    <input type="submit" value="Register" class="w-full p-2 shadow rounded-lg bg-blue-600 hover:bg-blue-700 text-white cursor-pointer">
                </div>
                <div class="w-1/2 pl-2 py-2">
