        ...
        <form class="h-auto w-1/3 p-4 shadow-inner" method="post">
            ...
            <div class="flex flex-wrap flex-row mt-10 xl:mt-20">
                <div class="w-1/2 pr-2 py-2">
                    <input type="text" name="first_name" placeholder="First name" class="focus:outline-none focus:shadow-outline w-full py-3 px-4 shadow rounded-lg">
                </div>
                <div class="w-1/2 pl-2 py-2">
                    <input type="text" name="last_name" placeholder="Last name" class="focus:outline-none focus:shadow-outline w-full py-3 px-4 shadow rounded-lg">
                </div>
            </div>
            <input type="text" placeholder="Email" class="focus:outline-none focus:shadow-outline w-full py-3 px-4 shadow rounded-lg my-2">
            <div class="flex flex-wrap flex-row">
                <div class="w-1/2 pr-2 py-2">
                    <input type="password" name="password" placeholder="Password" class="focus:outline-none focus:shadow-outline w-full py-3 px-4 shadow rounded-lg">
                </div>
                <div class="w-1/2 pl-2 py-2">
                    <input type="password" name="confirm_password" placeholder="Confirm Password" class="focus:outline-none focus:shadow-outline w-full py-3 px-4 shadow rounded-lg">
                </div>
            </div>
            <div class="flex flex-wrap flex-row">
                <div class="w-1/2 pr-2 py-2">
